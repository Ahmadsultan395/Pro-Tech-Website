...
const ServicesMain = () => {
  ...
  return (
    ...
    <div className='px-8 py-5 md:py-10 md:px-28'>
        ...
        <div className='flex flex-col md:flex-row justify-center gap-3 md:gap-3 '>
            {listData.map((row, index)=>(
                <div key={index} className='md:max-w-sm border-[1px] border-gray-700 p-5 rounded-xl mt-0 md:mt-10 
